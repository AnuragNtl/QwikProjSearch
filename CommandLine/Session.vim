...
inoremap <silent> <SNR>119_yrrecord =YRRecord3()
imap <M-S-Right> :2winc<i
imap <M-S-Left> :2winc>i
imap <M-S-Down> :2winc-i
imap <M-S-Up> :2winc+i
imap <F5> l:ei
noremap! <silent> <F4> :SyntasticCheck
imap <F9>  set makeprg=make\ -C\ ./build :make --no-print-directory  :TagbarClose :cw  :TagbarOpen i
imap <C-F5>   :call BuildAndInstallCSharpApp()
imap <C-F8>   :call BuildAndInstallQtApp()
...
nmap f :exe "CtrlSF" expand('<cword>') 
noremap  h
...
map  <Plug>(ctrlp)
snoremap  b<BS>
nmap d :set splitbelow:scs find d =expand("<cword>"),cok:set nosplitbelow
nmap i :set splitbelow:scs find i =expand("<cword>"),cok:set nosplitbelow
nmap f :set splitbelow:scs find f =expand("<cword>"),cok:set nosplitbelow
nmap e :set splitbelow:scs find e =expand("<cword>"),cok:set nosplitbelow
nmap t :set splitbelow:scs find t =expand("<cword>"),cok:set nosplitbelow
nmap c :set splitbelow:scs find c =expand("<cword>"),cok:set nosplitbelow
nmap g :set splitbelow:scs find g =expand("<cword>"),cok:set nosplitbelow
nmap s :set splitbelow:scs find s =expand("<cword>"),cok:set nosplitbelow
nmap  g
nnoremap <silent> # #zz
snoremap % b<BS>%
xnoremap & :&&
...
nmap ,{ ysiw{
nmap ,gr :grep 
nnoremap <silent> ,yp :YRReplace '-1', P
...
nnoremap ,tn :call NumberToggle()
nmap ,ag :exe "Ack " expand('<cword>') 
noremap ,yr :YRShow 
nnoremap ,sm :SignatureToggleSigns
nnoremap ,fo :setlocal foldexpr=(getline(v:lnum)=~@/)?0:1 foldmethod=expr fml=0 foldlevelstart=0 foldcolumn=1 
nmap ,= :call switch#Switch(g:variable_style_switch_definitions) 
nmap ,- :Switch 
nmap ,gt :GotoFileWithLineNumTag 
map ,gu :GundoToggle
...
nmap ,uad :call UpdateAllCscopeDatabases():w
nmap ,ud :silent call UpdateCscopeDatabase("."):w
nmap ,ct :silent call LoadCCTree()
nmap <silent> ,sv :w :so $MYVIMRC
...
nmap ,cw :q:cclose
nmap ,cq :cclose
nmap ,co :call OpenQuickFixInRightLocation()
nmap ,v V
vmap ,P "+P
vmap ,p "+p
nmap ,P "+P
...
nnoremap <silent> <SNR>119_yrrecord :call YRRecord3()
...
noremap <silent> <F4> :SyntasticCheck
nmap <S-Tab> :bp 
nmap <F9>> :set makeprg=make\ -C\ . :make --no-print-directory  :TagbarClose :cw  :TagbarOpen 
nmap <C-F5>  :call BuildAndInstallCSharpApp()
nmap <C-F8>  :call BuildAndInstallQtApp()
nmap <F8>  :call BuildAndInstallCppApp()
map <F3><F3> :execute "call MySearchSelectedText (\"".expand("<cword>") . "\")" | botright cw
map <F3> :call MySearchText() | botright cw
vnoremap <F1> 
nnoremap <F1> 
...
imap ,is :IHS:A
imap ,ih :IHS
imap ,uad l:call UpdateAllCscopeDatabases():wi
imap ,ud l:silent call UpdateCscopeDatabase("."):wi
imap ,mon :split:vsplit<C-Down>:vsplit<C-Up>,li
...
set tabstop=2
set tags=./tags,./TAGS,tags,TAGS,~/.vim/tags/last_project_tags,~/.vim/tags/dtv_project_tags,~/.vim/tags/gstreamer_tags,~/.vim/tags/mythtv_tags,~/.vim/tags/cpp_tags,~/.vim/tags/usr_local_include_tags
set textwidth=79
set title
set undodir=/tmp
set undofile
...
set updatetime=300
set visualbell
set wildignore=.hg,.git,.svn,*.aux,*.out,*.toc,*.jpg,*.bmp,*.gif,*.png,*.jpeg,*.o,*.obj,*.exe,*.dll,*.manifest,*.spl,*.sw?,*.DS_Store,*.luac,migrations,*.pyc,*.orig,*.rej
set wildmenu
set wildmode=list:longest
let s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
let v:this_session=expand("<sfile>:p")
silent only
cd ~/QwikProjSearch/CommandLine
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +37 ~/QwikProjSearch/CommandLine/RegexTemplateGeneration.cpp
badd +4 ~/QwikProjSearch/CommandLine/RegexTemplateSearcher.h
badd +10 ~/QwikProjSearch/CommandLine/RegexTemplateSearcher.cpp
badd +26 ~/QwikProjSearch/CommandLine/RegexTemplateMenuGenerator.cpp
badd +10 ~/QwikProjSearch/CommandLine/RegexSearcher.h
badd +13 ~/QwikProjSearch/CommandLine/RegexSearcher.cpp
badd +23 ~/QwikProjSearch/CommandLine/Searcher.h
badd +1 ~/QwikProjSearch/CommandLine/QwikProjSearch.cpp
badd +1 ~/QwikProjSearch/CommandLine/Searcher.cpp
args RegexTemplateGeneration.cpp
edit ~/QwikProjSearch/CommandLine/RegexSearcher.cpp
...
exe 'vert 2resize ' . ((&columns * 33 + 75) / 150)
exe '3resize ' . ((&lines * 36 + 21) / 42)
exe 'vert 3resize ' . ((&columns * 116 + 75) / 150)
argglobal
enew
file ~/QwikProjSearch/CommandLine/-MiniBufExplorer-
let s:cpo_save=&cpo
set cpo&vim
...
argglobal
enew
file ~/QwikProjSearch/CommandLine/NERD_tree_1
let s:cpo_save=&cpo
set cpo&vim
...
noremap <buffer> <silent> K :exe "Man" 3 expand('<cword>') 
nnoremap <buffer> <silent> gn :call clickable#do('gn')
vnoremap <buffer> { S{}Pk=iB
nnoremap <buffer> <silent> <S-2-LeftMouse> :call clickable#do('[s-2-leftmouse]')
nnoremap <buffer> <silent> <C-2-LeftMouse> :call clickable#do('[C-2-leftmouse]')
nnoremap <buffer> <silent> <C-CR> :call clickable#do('[C-CR]')
nnoremap <buffer> <silent> <S-CR> :call clickable#do('[S-CR]')
nnoremap <buffer> <silent> <2-LeftMouse> :call clickable#do('[2-leftmouse]')
inoremap <buffer> /* /*/kA 
...
setlocal errorformat=
setlocal expandtab
if &filetype != 'cpp.cpputest'
setlocal filetype=cpp.cpputest
endif
setlocal foldcolumn=0
setlocal foldenable
setlocal foldexpr=0
...
setlocal noswapfile
setlocal synmaxcol=3000
if &syntax != 'cpp.cpputest'
setlocal syntax=cpp.cpputest
endif
setlocal tabstop=2
setlocal tags=
setlocal textwidth=79
